...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider "virtualbox" do |vb, override|
    ...
    # Shared storage for Actinium-ng source code
    override.vm.synced_folder "../Actinium-ng", "/Actinium-ng"
  end
  ...
  config.vm.provider :aws do |aws, override|
    ...
    override.vm.synced_folder "../Actinium-ng", "/Actinium-ng", type: "rsync", rsync__exclude: ".git/"
  end
